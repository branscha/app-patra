...
implements PropertyChangeListener
{
    ...
    private void wireFormElements()
    {
        ...
        lengthSpinner.addChangeListener(new ChangeListener()
        {
            ...
            {
                unListen(); generator.setLength(((Number) lLengthModel.getValue()).intValue()); listen();
        ...
        final ActionListener lRadioListener = new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                unListen(); generator.setReadable(lReadable); listen();
                updateAlphabet();
            }
        };
        ...
        punctuationOption.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                unListen(); generator.setPunctuationIncluded(punctuationOption.isSelected()); listen();
                qualityDescription.setText(formatQualityMessage(generator.getQualityCategory(), Locale.ENGLISH));
            }
        });
        mixedOption.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e)
            {
                unListen(); generator.setMixedCase(mixedOption.isSelected()); listen();
                qualityDescription.setText(formatQualityMessage(generator.getQualityCategory(), Locale.ENGLISH));
            }
        });
        digitsOption.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e)
            {
                unListen(); generator.setNumbersIncluded(digitsOption.isSelected()); listen();
                qualityDescription.setText(formatQualityMessage(generator.getQualityCategory(), Locale.ENGLISH));
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        mainPanel.add(basicPanel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(300, -1), null, null));
        basicPanel.setBorder(BorderFactory.createTitledBorder(SupportCode.getResourceString("guiBundle", "generator.props")));
        readableSelection = new JRadioButton();
        SupportCode.setTextFromBundle(readableSelection, "guiBundle", "generator.props.readable");
        basicPanel.add(readableSelection, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        randomSelection = new JRadioButton();
        SupportCode.setTextFromBundle(randomSelection, "guiBundle", "generator.props.random");
        basicPanel.add(randomSelection, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        lengthPanel = new JPanel();
        lengthPanel.setLayout(new GridLayoutManager(1, 3, new Insets(0, 0, 0, 0), -1, -1));
        basicPanel.add(lengthPanel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null));
        final Spacer spacer1 = new Spacer();
        lengthPanel.add(spacer1, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null));
        lengthSpinner = new JSpinner();
        lengthPanel.add(lengthSpinner, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(50, -1), null, null));
        lengthLabel = new JLabel();
        lengthLabel.setHorizontalAlignment(11);
        lengthLabel.setHorizontalTextPosition(4);
        SupportCode.setTextFromBundle(lengthLabel, "guiBundle", "generator.props.length");
        lengthPanel.add(lengthLabel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(45, -1), null, null));
        alphabetPanel = new JPanel();
        alphabetPanel.setLayout(new GridLayoutManager(3, 1, new Insets(0, 0, 0, 0), -1, -1));
        mainPanel.add(alphabetPanel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        alphabetPanel.setBorder(BorderFactory.createTitledBorder(SupportCode.getResourceString("guiBundle", "generator.alphabet")));
        punctuationOption = new JCheckBox();
        SupportCode.setTextFromBundle(punctuationOption, "guiBundle", "generator.alphabet.punctuation");
        alphabetPanel.add(punctuationOption, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        digitsOption = new JCheckBox();
        SupportCode.setTextFromBundle(digitsOption, "guiBundle", "generator.alphabet.digits");
        alphabetPanel.add(digitsOption, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        mixedOption = new JCheckBox();
        SupportCode.setTextFromBundle(mixedOption, "guiBundle", "generator.alphabet.case");
        alphabetPanel.add(mixedOption, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null));
        ...
        panel1.add(qualityDescription, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null));
        final Spacer spacer2 = new Spacer();
        panel1.add(spacer2, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null));
    }
}
